...
window.proxyDatabase = {
    ...
    1996: { 'SCHD': [0.1734, 0.4482], 'DGRO': [0.0528, 0.2182], 'VPU': [0.0200, 0.5393], 'VOO': [0.2250, 0.0373], 'QQQM': [0.4254, 0.0020], 'SMH': [0.4173, 0.0000], 'VGT': [0.1558, 0.4508] },
    ...
    2026: { 'SCHD': [0.2670, 0.0189], 'DGRO': [0.1573, 0.0096], 'VPU': [0.0230, 0.0141], 'VOO': [0.1401, 0.0062], 'QQQM': [0.1767, 0.0027], 'SMH': [0.5811, 0.0000], 'VGT': [0.2791, 0.0025] },
};
