...
window.proxyDatabase = {
    ...
    2008: { 'SCHD': [-0.3192, 0.0500], 'DGRO': [-0.2669, 0.0267], 'VPU': [-0.2795, 0.0499], 'VOO': [-0.3680, 0.0261], 'QQQM': [-0.4173, 0.0031], 'SMH': [-0.4575, 0.0000], 'VGT': [-0.4282, 0.0064] },
    ...
    2026: { 'SCHD': [0.2722, 0.0189], 'DGRO': [0.1334, 0.0153], 'VPU': [-0.0207, 0.0141], 'VOO': [0.1169, 0.0062], 'QQQM': [0.1499, 0.0027], 'SMH': [0.5053, 0.0000], 'VGT': [0.2636, 0.0025] },
};
